...
def yolov5s_hat(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    # YOLOv5-xlarge-P6 model https://github.com/ultralytics/yolov5
    return _create('yolov5s_hat', pretrained, channels, classes, autoshape, _verbose, device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='yolov5s_flash', help='model name')
    ...
    imgs = [
        ...
        'data/images/flash/flash_table.png',  # flash
